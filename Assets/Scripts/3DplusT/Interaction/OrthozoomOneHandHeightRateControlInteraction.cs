...
public class OrthozoomOneHandHeightRateControlInteraction : RateControlFuctionInteraction
{
    ...
    public override float CalculateRate(){
        ...
        if(rightHand){
            ...
            height = rightCurrentPos.y - rightStartPos.y;
        }
        else{
            distance = leftCurrentPos.x - leftStartPos.x;
            height = leftCurrentPos.y - leftStartPos.y;
        }
